...
export const fr = {
  ...
  labelImageSettings: "Paramètres d'Image",
  labelResolution: "Résolution (Gemini)",
  labelAspectRatio: "Format d'Image",
  labelQuality: "Qualité (OpenAI)",
  qualityStandard: "Standard",
  qualityHD: "HD",
  labelStyle: "Style Artistique",
