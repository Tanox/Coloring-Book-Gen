/* app/components/Header.tsx v0.3.8 */
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-28 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
             ...
             <button
               ...
               className="p-5 text-white bg-amber-400 hover:bg-amber-500 rounded-full transition-all hover:-rotate-12 active:scale-95 border-2 border-amber-200 dark:border-amber-600 shadow-lg shadow-amber-200/50"
             >
             ...
             <button 
                ...
                className={`p-5 text-white rounded-full transition-all hover:rotate-12 active:scale-95 border-2 shadow-lg ${isChatOpen ? 'bg-indigo-600 border-indigo-400' : 'bg-sky-400 border-sky-200'}`}
             >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
